    ...
    >
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.topBar}>
          <TouchableOpacity onPress={() => router.canGoBack() ? router.back() : router.replace('/(auth)/welcome' as any)} style={styles.backButton}>
        ...
        <View style={styles.form}>
          ...
          <Button 
            ...
            size="lg"
            leftElement={<Ionicons name="call" size={20} color="#fff" style={{ marginRight: 8 }} />}
          />
          ...
          <Button 
            ...
            textStyle={{ color: '#000' }}
            size="lg"
            leftElement={<Ionicons name="logo-google" size={20} color="#db4437" style={{ marginRight: 8 }} />}
          />
          ...
          <TouchableOpacity onPress={() => router.push('/(auth)/supplier-email-auth' as any)} style={styles.forgotPassword}>
            <Text style={styles.forgotPasswordText}>Login with Email & Password</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  topBar: { flexDirection: 'row', alignItems: 'center', marginBottom: theme.spacing.xl, marginTop: Platform.OS === 'ios' ? theme.spacing.xl : theme.spacing.md },
  backButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: theme.colors.surface, justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2 },
  header: { marginBottom: theme.spacing.xl, alignItems: 'flex-start' },
  title: { fontSize: 32, fontWeight: 'bold', color: theme.colors.textPrimary, marginBottom: theme.spacing.xs },
  subtitle: { fontSize: 16, color: theme.colors.textSecondary, lineHeight: 24 },
  form: { width: '100%', marginTop: 20 },
  phoneButton: { marginBottom: 16, backgroundColor: theme.colors.primary, shadowColor: theme.colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 },
  googleButton: { marginBottom: 24, backgroundColor: '#fff', borderWidth: 1, borderColor: '#ddd', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 2 },
  errorText: { color: theme.colors.error, fontSize: 14, marginBottom: 16, textAlign: 'center' },
  ...
  forgotPasswordText: { color: theme.colors.textSecondary, fontSize: 16, fontWeight: '500' },
