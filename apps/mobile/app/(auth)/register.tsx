    ...
    >
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Join AquaKart for fresh water delivery.</Text>
        </View>
        ...
        <View style={styles.form}>
          <Input
            ...
            error={errors.name}
            leftElement={<Ionicons name="person-outline" size={20} color={theme.colors.textTertiary} />}
          />
          <Input
            label="Email Address"
