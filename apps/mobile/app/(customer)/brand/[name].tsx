  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Pressable 
          style={[styles.btn, (totalQty === 0 || processing) && styles.btnDisabled]} 
          onPress={handlePlaceOrder}
          disabled={totalQty === 0 || processing}
        >
          <Text style={styles.btnText}>{processing ? 'Processing...' : 'Place Order'}</Text>
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderColor: '#eee', backgroundColor: theme.colors.surface },
  backBtn: { padding: 8, marginRight: 8 },
  headerTitle: { fontSize: 20, fontWeight: 'bold' },
  content: { padding: 16 },
  label: { fontSize: 16, fontWeight: 'bold', marginBottom: 12 },
  productCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 12, borderRadius: 8, marginBottom: 12, borderWidth: 1, borderColor: '#eee' },
  ...
  summaryCard: { backgroundColor: '#fff', padding: 16, borderRadius: 8, borderWidth: 1, borderColor: '#eee', marginBottom: 16, marginTop: 12 },
